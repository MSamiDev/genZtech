  ...
  return (
    <div id="DevOps" className="from-yellow-500 to-white bg-gradient-to-l">
      ...
      <div className="md:w-full md:flex md:justify-center" >
        <div
          id="Overview"
          className="w-full md:w-3/5 h-screen md:h-auto flex flex-col justify-center float-left"
        >
          <h1 className="px-6 md:px-20 pb-10 font-bold text-2xl md:text-5xl text-gray float-left text-center lg:text-left">
        ...
        {/* Git Image */}
        <div className="w-full md:w-2/5 flex justify-center py-10 md:py-0 h-screen md:h-auto items-center">
      ...
      <div className="md:w-full md:flex md:justify-center">
        <div
          id="What"
          className="w-full md:w-3/5 p-10 md:p-20 h-screen md:h-auto flex flex-col justify-center float-left"
        >
          <h1 className="p-6 md:p-20 pb-10 font-bold text-2xl md:text-5xl text-gray text-center lg:text-left">
            What is DevOps?
          </h1>
          <p className="px-6 md:px-20 pb-10 text-sm text-center md:text-lg lg:text-left">
      ...
      <div className="md:w-full md:flex md:justify-center">
        ...
        >
          ...
          <p className="px-6 md:px-20 pb-10 text-center text-sm md:text-lg lg:text-left">
