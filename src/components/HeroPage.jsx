...
const HeroPage = () => {
    return (
        ...
        <div className=" from-yellow-500   flex justify-center items-center to-white bg-gradient-to-r " id="Home">
            <div className="w-3/5 p-20 h-screen  flex flex-col justify-center float-left ">
