...
const HeroPage = () => {
  return (
    <div className="from-yellow-500 flex justify-center items-center to-white bg-gradient-to-l" id="Home">
      ...
      <div className="hidden sm:block sm:w-2/5 p-10 md:p-20 h-screen md:h-auto flex flex-col justify-center">
        <div
      ...
      <div className="w-full sm:w-3/5 flex-col justify-center p-10 md:p-20 items-center">
